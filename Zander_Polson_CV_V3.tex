...
\begin{minipage}[t]{0.686\textwidth}
	...
	from prototype through client-facing demonstrations.
	My current research explores plant-based simulation and synthetic data
	for robotic perception in agricultural robotics. Outside engineering, I pursue fitness and various adventure-sports.

	\cvsection{EXPERIENCE}
	\job{UViRCO}{Nov 2024 - Jun 2025}{Junior Software Engineer}{South Africa / China}
	\begin{itemize}
		\item Helped take the platform from prototype to first deployment and client demonstrations in less than six months, including an on-site demonstration for clients in China.
		\item Developed an embedded IoT and computer-vision platform for Raspberry Pi Compute Module 4 and 5 using C/C++, Python, and OpenCV, delivering a functional prototype capable of real-time image analysis.
	...
	\begin{itemize}
		\item Implemented a new web-interface feature in a custom Qt-based desktop application using C++ and QWebEngine, enabling users to access a remote radio interface in real-time.
	\end{itemize}
	\vspace{0.24em}
	...
	\begin{itemize}
		\item Developed the perception layer of a bottle-following mobile robot using RF-DETR on an NVIDIA Jetson Nano. Collaborated with other Japanese graduates who developed the LiDAR-based navigation stack. We integrated the perception and navigation components using ROS to enable real-time target detection and following.
	\end{itemize}
...
\begin{minipage}[t]{0.279\textwidth}
	\RaggedRight
	\cvsection{EDUCATION}
	\education{MS, Advanced Robotics}{2025 - Present}{Chiba Institute of Technology}{Japan}
